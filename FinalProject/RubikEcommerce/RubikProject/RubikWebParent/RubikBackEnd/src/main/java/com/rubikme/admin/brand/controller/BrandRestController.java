...
import com.rubikme.admin.brand.CategoryDTO;
import com.rubikme.admin.brand.error.BrandNotFoundException;
import com.rubikme.admin.brand.error.BrandNotFoundRestException;
...
public class BrandRestController {
	...
	public List<CategoryDTO> listCategoriesBrand(@PathVariable(name = "id") Integer brandId) throws BrandNotFoundRestException {
